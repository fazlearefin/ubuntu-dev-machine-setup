...
- Enabling some [ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) plugins like **docker** results in the error: `No such file or directory`. You can easily fix this by creating the missing directory manually: `mkdir -p ~/.antigen/bundles/robbyrussell/oh-my-zsh/cache/completions`.
